        ...
        <div class="form-head d-flex mb-3 mb-md-4 align-items-start justify-content-between">
            <div class="mr-auto d-lg-block">
                <a type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#add-shop-modal"
                    class="btn btn-primary btn-rounded">+ Add Affiliate</a>

                <!-- Start Add Affiliate Modal -->
                <div class="modal fade" id="add-shop-modal" data-backdrop="static">
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Add Affiliate</h5>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control input-default name" name="name"
                                                    required placeholder="Affiliate Name" value="{{ old('name') }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control input-default address"
                                                    name="address" required placeholder="Affiliate Address"
                                                    value="{{ old('address') }}">
                                            </div>
                                        </div>
                ...
                <!-- End Add Affiliate Modal -->

            </div>

            <form action="{{ route('affiliate.index') }}" method="get">
                        ...
                        <tbody>
                            @forelse ($lists as $list)
                                ...
                                <tr>
                                    ...
                                    <td>#AF-000{{ $id }}</td>
                                    <td>{{ $list->name }}</td>
                                    <td><a href="{{ route('api-key.index', $encoded_id) }}">{{ $list->keys_count }}</a>
                                    </td>
                                    <td>{{ $list->sub_affiliates_count }}</td>
                                    <td>
                                        ...
                                        <div class="d-flex">
                                            @if ($list->trashed())
                                                <a href="javascript:void(0)"
                                                    ...
                                                    title="Restore"
                                                    data-url="{{ route('affiliate.restore', $encoded_id) }}"
                                                ...
                                                <a href="javascript:void(0)"
                                                    ...
                                                    data-url="{{ route('affiliate.permanent-delete', $encoded_id) }}"
                                            ...
                                            @else
                                                <form action="{{ route('api-key.store') }}" method="POST">
                                                    ...
                                                    <input type="hidden" name="affiliate_id"
                                                        value="{{ $id }}">
                                                    <button type="submit" class="btn btn-dark shadow btn-xs sharp mr-1"
                                                        title="Generate Api Key"> <i class="fa fa-eye"></i></button>
                                                </form>
                                                <a href="javascript:void(0)"
                                                    class="btn btn-success shadow btn-xs sharp mr-1 ajax-request"
                                                    title="Add Sub Affiliate"
                                                    data-url="{{ route('sub-affiliate.add', $encoded_id) }}"
                                                ...
                                                <a href="javascript:void(0)"
                                                    ...
                                                    title="Edit" data-url="{{ route('affiliate.edit', $encoded_id) }}"
                                                    data-type="edit" data-reload="false" data-text="">
                                                ...
                                                <a href="javascript:void(0)"
                                                    ...
                                                    data-url="{{ route('affiliate.delete', $encoded_id) }}"
                                                    data-type="delete" data-reload="true"
